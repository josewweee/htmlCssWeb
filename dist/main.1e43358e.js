...
toggleButton.addEventListener('click', function () {
  if (navOptions.classList.contains('hide')) navOptions.classList.remove('hide');else navOptions.classList.add('hide');
});
...
var sections = [bannerSection, servicesSection, aboutSection, teamSection, portfolioSection, blogSection, contactSection];
...
var _loop = function _loop(_i) {
  accordionButton[_i].addEventListener('click', function () {
    //switch the selected accordion content to scroll down ( margin + increace height)
    var accordionBlock = accordionButton[_i].querySelector('.question-item--accordion');
